...
R is the programming language that you will use when working with data.
...
* The second Data Center workshop takes place in week 8. It will build on your existing R skills, with a focus on finding and cleaning data. These skills will help you write your final paper for the course.
