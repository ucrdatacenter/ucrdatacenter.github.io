...
When it comes to inflation, most countries in the Euro Area had average inflation rates around 2%, and inflation in the Euro Area was quite stable in the early 2000s.
...
Later you will see that thee countries were all badly hit by the debt crisis, so it is possible that having output above potential made these countries more vulnerable to shocks.
...
p1 <- infl %>% 
  ...
  ggplot(aes(LOCATION, Value)) +
  geom_col() +
  xlab(NULL) + ylab("Average inflation rate 2000-2007 (%)") +
  theme_light() +
  theme(axis.text.x = element_text(angle = 90))
...
Despite the high levels of economic integration, there were significant differences in how Euro Area countries developed in the early 2000s, affecting how badly each country was hit by the crisis.
You already saw that most Euro Area economies seemed to operate around the natural level of output, but some peripheral economies exhibited high inflation rates, suggesting output above the natural level.
These economies were also affected by some other ongoing trends: 

- changes in the competitiveness of economies, as reflected by labor costs;
- growth in consumption and investment fuelled by housing market booms;
- growth in borrowing driven by interest rate convergence.
...
The following figure shows that Ireland and Greece both had major increases in labor costs before the crisis compared to e.g. Germany, corresponding to a loss in competitiveness in these countries.
...
In addition, the UK, Ireland and Spain had housing bubbles similar to the US, while the governments Greece and Italy were accumulating a lot of debt to finance their budget deficits already in the years prior to the crisis.
...
To fit this pattern into the IS-LM framework, you can consider the housing bubbles to increase consumer confidence, prompting consumers to consume more, and therefore shifting the IS curve to the right, and output above potential.

A similar story applies to the low interest rates, but there output increased due to a downward shift in the LM curve: the introduction of the Euro eliminated exchange rate risk in peripheral economies, while trust in the ECB to bail countries out if necessary removed much of the default risk.
So next to having a single policy rate in the Euro Area, the risk premia in peripheral economies fell, leading to further convergence in interest rates.
That is how peripheral economies experienced falling interest rates that made it more attractive to them to borrow money from abroad.
Governments that borrowed at these low interest rates increased their budget deficits, while the private investment boom from the lower interest rates can be described as a movement along the IS curve driven by a downward shift of the LM curve.
Both public and private spending contributed to pushing output above potential, therefore increasing inflation rates and making countries more vulnerable to shocks.
