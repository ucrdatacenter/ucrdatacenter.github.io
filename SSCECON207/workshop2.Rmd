...
Several useful data sources are listed [here](https://ucrdatacenter.github.io/SSCECON207#Supporting_materials13); additionally you can always simply Google the indicator that you are looking for.
...
GDP <- read_csv("https://github.com/ucrdatacenter/projects/raw/main/SSCECON207/2022h1/workshop%202%20data/DP_LIVE_14032022133237321.csv")
CO2 <- rio::import("https://github.com/ucrdatacenter/projects/raw/main/SSCECON207/2022h1/workshop%202%20data/API_EN.ATM.CO2E.PC_DS2_en_excel_v2_3732111.xls", skip = 3)
```
...
full_data <- full_join(GDP_final, CO2_final, 
                       by = c("country" = "country", "year" = "year")) # is equivalent to the previous line, but explicitly specifies the matching variables
```
