...
If you have not done so yet, please follow [this installation tutorial](https://ucrdatacenter.github.io/tutorial/r_basics.html).
...
In addition, create a new project for the Macroeconomics course, and install the `tidyverse` package, as explained in [here](https://ucrdatacenter.github.io/tutorial/r_basics.html).
...
The code shown in the videos is available on [Github ADD LINK](link).

### [**---Introduction to R video TBA---**](link) {.unlisted .unnumbered}
...
If you are interested, more information on importing files with other data formats, and writing your own import code are shown in [this tutorial](https://ucrdatacenter.github.io/tutorial/r_data.html).

### [**---Data import video TBA---**](link) {.unlisted .unnumbered}
...
### [**---Data cleaning video part 1 TBA---**](link) {.unlisted .unnumbered}
...
### [**---Data cleaning video part 2 TBA---**](link) {.unlisted .unnumbered}
...
### [**---`ggplot` video TBA---**](link) {.unlisted .unnumbered}