...
You can find a list of the dossiers and the number of corresponding meetings and attendees [here](https://github.com/ucrdatacenter/projects/blob/main/SSCPOLI302/2024h2/List%20of%20legislative%20files.pdf).
...
This list contains too many different entities to create a readable plots, so let's try to group the attendees by their class and structure, which we previously defined manually.
Then we can plot the distribution of these categories.
