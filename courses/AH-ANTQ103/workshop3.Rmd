...
Base R has a data set installed that lists a lot of common stop words which we can use to get rid of the unimportant words.
...
Here I give a silly example of how to use this function. In your homework, it will actually be useful.
