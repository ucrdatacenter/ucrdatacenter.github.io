...
Then, you apply the same skills to a homework assignment.
...
1. [Data wrangling: filtering rows and selecting columns](../../../tutorials/r_intro_subset) (`filter()` only)
1. [The tidy workflow](../../../tutorials/r_intro_pipe)
1. [Text analysis in R](../../../tutorials/r_text)
1. [Data visualization: introduction to `ggplot`](../../../tutorials/r_ggplot_intro)
1. [Data visualization: relationships between variables](../../../tutorials/r_ggplot_bivariate) (bar charts only)
