...
This tutorial assumes that you completed the preparatory steps listed [here](../SCICOGN302.html#First_workshop).
...
In the following case, it takes the object `tokens` as the first argument of the `filter()` function, and then takes the resulting filtered data as the first argument of the `count()` function.
