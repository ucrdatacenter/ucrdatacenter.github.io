...
In some cases you might need to summarize your data to understand it better and to compare different groups.
In this tutorial, we will show you how to summarize data within groups using the `group_by()` and `summarize()` functions from `tidyverse` functions and the `diamonds` dataset (which comes pre-loaded with `tidyverse` so you don't need to import it).
