...
When working on projects in R, you will likely need to draw data from a variety of online sources.
...
The most common formats are Excel files (.xlsx or .xls extensions), SPSS files (.sav extension), and Stata files (.dta extension).
...
At the beginning, you can let R do most of the work of importing data instead of figuring out the right functions and arguments yourself.
...
Files will most likely be saved to your Downloads folder.
In order to import it to R, you should first move it to your project folder, or use the full file path when specifying the file name.

In order to import files to R, open your project in RStudio.
Find *File* -> *Import dataset* in the top left of RStudio, and choose the correct file format.
...
In the data import pop-up window click "Browse" and find the data that you would like to import.
...
Additionally, you should change the name of the data to something short and sensible, as you will refer to that name quite frequently in your code.
...
Importing an Excel file is almost exactly the same, except you you should click File -> Import Dataset -> From Excel.
...
If you would like to learn more about importing data, have a look at the *Importing data* section of the [R basics tutorial](r_basics.html#Importing_data).