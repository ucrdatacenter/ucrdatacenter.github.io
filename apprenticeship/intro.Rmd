...
* **Add to R basics tutorial: tour of RStudio panes, how to create and save a new script**

Before the first workshop, please make sure that you have access to R and RStudio on your laptop.
If you need help with the installation, please follow [this tutorial](https://ucrdatacenter.github.io/tutorial/r_install.html).

The [R basics tutorial](https://ucrdatacenter.github.io/tutorial/r_basics.html) on the Data Center website explains the RStudio interface, and shows how to create a new project and how to install packages.
