...
Use what you learned in the [first Data Center workshop](SCICOGN302/workshop1) to complete the following assignment.
...
If you choose to use the CHILDES database for your final poster, you can find the poster guidelines [here](SCICOGN302/poster_guidelines).
...
* install R and RStudio ([installation tutorial](https://ucrdatacenter.github.io/tutorial/r_install.html))
...
[This video (6:18)](https://vimeo.com/860596815/4a202dd077?share=copy) and [this tutorial](https://ucrdatacenter.github.io/tutorial/r_basics.html) explain the layout of RStudio, how to create a project, and how to install and load packages.
...
You can find the workshop handout [here](SCICOGN302/workshop1), and additional workshop materials [here](SCICOGN302/workshop1extra).
...
The case study discussed in the workshop is available [here](SCICOGN302/workshop2).