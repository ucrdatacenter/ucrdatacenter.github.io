...
It does not seem like the topics can separate the two books, maybe because Winnie-the-Pooh is longer and the model tries to create about equal-sized topics.

The per-document-per-topic probabilities confirm that the the documents are not clearly split into topics, as both documents have an ~60% probability of belonging to topic 1 and 40% probability of belonging to topic 2.
